...
Basketball as a sport is changing, players like Stephen Curry have changed perceptions around what a point guard is supposed to do, Nikola Jokic is reinventing the center position. Another even bigger change is the advent of extremely tall players playing seemingly positionless basketball, the trend started by players like Kevin Durant and Kristaps Porzingis, and continued by younger guys like Chet Holmgren and Victor Wembanyama.

People are playing basketball differently and that calls for different positions. The old labels of point guard, shooting guard, center, power forward, and small forward don't seem to apply as well anymore.
